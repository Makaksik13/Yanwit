package OS.Yanwit.config.redis;

import OS.Yanwit.property.RedisCacheProperty;
import OS.Yanwit.property.RedisLockRegistryProperty;
...
public class RedisCacheConfig {
    ...
    @Bean
    public ZSetOperations<String, Object> redisFeedZSetOps(RedisTemplate<String, Object> feedRedisTemplate){
